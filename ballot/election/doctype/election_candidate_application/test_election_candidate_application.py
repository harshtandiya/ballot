...
class TestElectionCandidateApplication(FrappeTestCase):
	...
	def test_modify_other_application(self):
		...
		self.assertTrue(self.application.get_doc_before_save().full_name != self.application.full_name)
	...
	def test_candidate_creation(self):
		...
		candidate_exists = frappe.db.exists(
			CANDIDATE_DOC,
			{
				"election": self.application.election,
				"linked_application": self.application.name
			}
		)
